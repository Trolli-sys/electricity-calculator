...
HOLIDAYS_TOU_2025_STR = [
    ...
    # "2025-04-06", # Chakri Memorial Day (Actual Sunday)
    "2025-04-07", # Substitution for Chakri Day
    "2025-04-13", # Songkran Festival (Sunday)
    "2025-04-14", # Songkran Festival
    "2025-04-15", # Songkran Festival
    "2025-05-01", # National Labour Day
    "2025-05-05", # Coronation Day
    # "2025-05-10", # Visakha Bucha Day (Actual Saturday - Tentative, check official lunar calendar)
    "2025-05-12", # Substitution Day (Mon) - Tentative, Needs official check
    "2025-06-03", # HM Queen Suthida's Birthday
    "2025-07-10", # Asanha Bucha Day (Tentative, check official lunar)
    "2025-07-11", # Buddhist Lent Day (Tentative, check official lunar)
    "2025-07-28", # HM King Maha Vajiralongkorn's Birthday
    "2025-08-12", # HM Queen Sirikit The Queen Mother's Birthday / Mother's Day
    "2025-10-13", # HM King Bhumibol Adulyadej The Great Memorial Day
    "2025-10-23", # Chulalongkorn Day
    "2025-12-05", # HM King Bhumibol Adulyadej The Great's Birthday / National Day / Father's Day
    "2025-12-10", # Constitution Day
    "2025-12-31", # New Year's Eve
    # เพิ่มวันหยุดนักขัตฤกษ์ตามประกาศจริงสำหรับปี 2025 และปีอื่นๆ
]
...
st.title("📊 โปรแกรมคำนวณค่าไฟฟ้า (รองรับหลายรูปแบบไฟล์ + จำลอง EV)")
st.markdown("""
แอปพลิเคชันนี้ช่วยคำนวณค่าไฟฟ้าโดยประมาณจากไฟล์ข้อมูล Load Profile
รองรับไฟล์ .txt หรือ .csv ที่มีรูปแบบทั่วไป (Tab-separated หรือ Comma-separated)
**ข้อควรระวัง:** อัตราค่าไฟฟ้า, ค่า Ft, และวันหยุด ควรตรวจสอบและอัปเดตให้เป็นปัจจุบันเสมอ
""")
