...
HOLIDAYS_TOU_2024_STR = ["2024-01-01","2024-01-06","2024-01-07","2024-01-13","2024-01-14","2024-01-20","2024-01-21",
                         ...
                         "2024-10-05","2024-10-06","2024-10-12","2024-10-13", # แก้ไข: ลบรายการซ้ำ 2024-10-05, 2024-10-06, 2024-10-12
...
# ทำความสะอาดรายการวันหยุด (ลบรายการซ้ำและเรียงลำดับ) - ควรทำความสะอาดรายการปี 2024 ด้วย
...
if st.session_state.full_dataframe is not None and not st.session_state.full_dataframe.empty:
    ...
    # Checkbox for showing the graph (Original - plots all data)
    # if st.checkbox("📊 แสดงกราฟ Load Profile (ข้อมูลดิบจากไฟล์)", key="show_graph"):
    #    # ... (code to plot all data) ...

    # <<< เพิ่มส่วนนี้ หรือ แก้ไขส่วนเดิม >>>
